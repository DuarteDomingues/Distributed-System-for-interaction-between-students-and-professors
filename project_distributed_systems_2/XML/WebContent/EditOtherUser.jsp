...
<!-- Start Header -->
 ...
 if ((boolean) session.getAttribute("isProf")){
	...
	<%
		...
		String arr[] = ServerData.getOtherUserInfo();
			...
			<form  action="${pageContext.request.contextPath}/EditUser"    method="POST" id="signup-form" class="signup-form"
				...
				<div class="form-group">
					<label> Username: </label> <input type="text"
						class="form-input input-lg" name="username1" id="username"
						placeholder="<%=arr[0]%>" />
				...
				<div class="form-group">
					<label> Surname: </label> <input type="text"
						class="form-input input-lg" name="surname1" id="username"
						placeholder="<%=arr[1]%>" />
				...
				<div class="form-group">
					<label> Address: </label> <input type="text"
						class="form-input input-lg" name="address1" id="address"
						placeholder="<%=arr[2]%>" />
				...
				<div class="form-group">
					<label> Email: </label> <input type="email"
						class="form-input input-lg" name="email1" id="email" placeholder="<%=arr[5]%>" />
				</div>

				<div class="form-group">
					<label> Nationality: </label> <select id="country" name="country1"
				...
				<div class="form-group">
					<label> Telephone: </label> <input type="text"
						class="form-input input-lg" name="telephone1" id="address"
						placeholder="<%=arr[6]%>"/>
				...
				<div class="form-group">
					<label> Language: </label> <input type="text"
						class="form-input input-lg" name="language1" id="address"
						placeholder="<%=arr[8]%>" />
