...
<!-- Start Header -->
 ...
 if ((boolean) session.getAttribute("isProf")){
	...
	<%
		...
		String arr[] = ServerData.getArrUserInfo();
	...
	<main id="main"> <section class="inner-page"> <section
		class="signup">
	<div class="container">
		...
		<% if(isProf){ %>
			<form  action="${pageContext.request.contextPath}/EditUser" method="POST" id="signup-form" class="signup-form"
			 name="FormRegist" onsubmit="return FormRegistValidator(this ,password_validation )">
				<h2 class="form-title">
					Edit <span>information</span>
				</h2>
				&nbsp;

				<div class="form-group">
					<label> Username: </label> <input type="text"
						class="form-input input-lg" name="username" id="username"
						placeholder="<%=arr[0]%>" />
				...
				<div class="form-group">
					<label> Surname: </label> <input type="text"
						class="form-input input-lg" name="surname" id="username"
						placeholder="<%=arr[1]%>" />
				...
				<div class="form-group">
					<label> Address: </label> <input type="text"
						class="form-input input-lg" name="address" id="address"
						placeholder="<%=arr[2]%>" />
				...
				<div class="form-group">
					<label> Email: </label> <input type="email"
						class="form-input input-lg" name="email" id="email" placeholder="<%=arr[5]%>" />
				</div>

				<div class="form-group">
					<label> Nationality: </label> <select id="country" name="country"
						...
						<option value="Cock Islands">Cook Islands</option>
				...
				<div class="form-group">
					<label> Telephone: </label> <input type="text"
						class="form-input input-lg" name="telephone" id="address"
						placeholder="<%=arr[6]%>"/>
				...
				<div class="form-group">
					<label> Language: </label> <input type="text"
						class="form-input input-lg" name="language" id="address"
						placeholder="<%=arr[8]%>" />
				...
				<div class="form-group">
					<label> Password: </label> <input type="password"
						class="form-input input-lg" name="password" id="address"
						placeholder="" />
		...
		%>
		<form  action="${pageContext.request.contextPath}/EditStudent"    method="POST" id="signup-form" class="signup-form"
