...
<!-- Start Header -->
 ...
 if ((boolean) session.getAttribute("isProf")){
	...
	<div class="container">
		...
		<% if(isProf){ %>
			<form  action="${pageContext.request.contextPath}/CreateStudent"    method="POST" id="signup-form" class="signup-form"
				onsubmit="" name="FormRegist">
				<h2 class="form-title">
					Create <span>Student</span>
				</h2>
				&nbsp;
				...
				<div class="form-group">
					<label> Email: </label> <input type="email"
						class="form-input input-lg" name="email" id="email" placeholder="email" />
				</div>
				...
				<div class="form-group">
					<label> Number: </label> <input type="text"
						class="form-input input-lg" name="number" id="address"
						placeholder="number"/>
				...
				<div class="form-group">
					<label> Gender: </label> <input type="text"
						class="form-input input-lg" name="gender" id="address"
						placeholder="gender"/>
