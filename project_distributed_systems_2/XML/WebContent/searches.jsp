	...
	<section class="inner-page">
		...
		<h1> Searches</h1>
		 ...
		 for (String i : users.keySet()) {
			 ...
			 if (users.get(i).length() >= inputLen){
				 
					String splited = users.get(i).substring(0,inputLen);
					
					if ((splited.toLowerCase()).equals((userInput).toLowerCase()) ) {
