...
<%@ page import="user.ProcessOtherUser"%>
...
<%
	...
	ProcessOtherUser proInfo = new ProcessOtherUser();
	...
	String idOtherUser = proInfo.getUserId();
	
	ServerData.updateOtherUserInfo(arrInfo);
	
	session.setAttribute("idOtherUser", idOtherUser);
...
if ((boolean) session.getAttribute("isProf")){
    ...
    <form  action="EditOtherUser.jsp" method="POST" id="edit_user_form" name="editForm" class="signup-form">
<div class="form-group_2">
...
<div class="col-sm-3 col-xs-6 tital " >
<form  action="ManageDelete" method="POST" id="edit_user_form" name="editForm" class="signup-form">
<div class="form-group_2">
   <input type="submit" id="submit" type="button" class="btn btn-primary"  value="Delete"/>
    </div>
