...
public class Expressions {
	...
	//incorreto
	public static final String incorrect = "<incorreto></incorreto>";
	
	
	//req chat by id
	
	public static final String reqChat = "<reqChat>";
	public static final String reqChatEnd = "</reqChat>";

	//response
	
	public static final String responseGroups = "<messageGroups>";
	
	
	
	//sever send info with ucs for user in register
	
	public static final String registerRequest = "<request_ucs>";
	public static final String registerResponse ="<groups>";
	...
	public static final String updateStudentInfo = "<UpdateStudent>";
	public static final String updateStudentInfoEnd = "</UpdateStudent>";
	...
	//request other user profile
	
	public static final String requestOtherUser = "<requestUser>";
    public static final String requestOtherUserEnd = "</requestUser>";
    
    //reply other user
    public static final String replyOtherUser = "<otherUser";

	//send req of all students
    public static final String reqAllStudents ="<reqStudents>";
    
    
    //request edit chat
    public static final String reqEditUserChat ="<reqEditChat>";
    public static final String reqEditUserChatFinal ="</reqEditChat>";
    
  //request create Student
    public static final String reqCreateStudent ="<reqCreateStudent>";
    public static final String reqCreateStudentEnd ="</reqCreateStudent>";
    
    //request delete student
    
    public static final String reqDelete = "<reqDelete>";
    
    //request change turma end
    public static final String reqChangeTurma = "<reqChangeTurma>";
    public static final String reqChangeTurmaEnd = "</reqChangeTurma>";
    
    public static final String responseChangeTurma = "<responseChangeTurma>";
    public static final String responseChangeTurmaEnd = "</responseChangeTurma>";
    
    //request change turma
    public static final String reqChangeTurmaEdit = "<reqChangeTurmaEdit>";
    public static final String reqChangeTurmaEditEnd = "</reqChangeTurmaEdit>";
    
    
    public static final String reqInfoUser = "<reqInfoUser>";
